...
const geojson = {
  ...
  features: [
    ...
    },
    {
      ...
      geometry: {
        type: "Point",
        coordinates: [-74.004959, 40.707130],
      },
      properties: {
        title: "Mapbox",
        name: "Coffee Project",
        location: "Financial District",
        recs: ["pour over,", "cold brew,", "cortado"],
        vibes: "modern", 
        text: "Coffee Project is a local chain coffee shop in New York City. It not only serves amazing coffee, but also offers professional classes for any skill level. You could even earn SCA certifications by joining their training lab. The owner leads a professional roasting team. When I first went to their Hell's kitchen location, I was told the Head Roaster just won a coffee competion. ",
      },
    },
  ],
};
